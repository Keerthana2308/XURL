...
public static final String token="SR6YOPBSTKYMDDRQ";
public static final String function="TIME_SERIES_DAILY";
  ...
  private String buildUri(String symbol) {
    String api=String.format("https://www.alphavantage.co/query?function=%s&Symbol=%s&apikey=%s",function,symbol,token);
     return api;
  }
