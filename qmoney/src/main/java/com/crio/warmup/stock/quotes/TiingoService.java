...
throw new StockQuoteServiceException("Error occured when request response from Tiingo API ",e.getCause());
      }
  }
  ...
  private String buildUri(String symbol, LocalDate from, LocalDate to) {
    String api="https://api.tiingo.com/tiingo/daily/"+symbol+"/prices?startDate="+from+"&endDate="+to+
